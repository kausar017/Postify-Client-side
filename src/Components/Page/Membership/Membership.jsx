        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="card w-full max-w-[500px] bg-white shadow-xl m-2 p-5 rounded-lg">
                ...
                <p className="text-sm text-gray-600 text-center mb-4">
                    <span className="text-red-600 text-xl font-bold"> 50$ </span>taka or Become a member to receive the <span className="text-yellow-500 font-bold">Gold Badge</span> and unlock the ability to post more than 5 posts.
                </p>
